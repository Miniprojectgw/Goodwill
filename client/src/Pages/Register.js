  ...
  return (
    ...
    <section className="bg-[#4579BB] min-h-screen flex items-center justify-center">
      ...
      <div className="md:w-1/2 px-8 md:px-16 items-center">
        ...
        <h2 className=" text-center font-bold p-5 text-5xl text-white  " style={{ fontFamily: 'Times New Roman, cursive' }}>Register with</h2>  <center><img  src="Goodwill.png"  alt="" className=""></img></center>
        ...
        <form action="" className="flex flex-col gap-4">
          ...
          <input className="p-1 rounded-xl" type="tel" onChange={ handleChange} name="phoneNumber"  id="phoneNumber" value={ phoneNumber } placeholder="Phone Number"></input>
          ...
          <div className="relative">
            <input className="p-1 rounded-xl border w-full" type="tel"  onChange={ handleChange} name="password"  id="password" value={ password }  placeholder="Password"></input>
